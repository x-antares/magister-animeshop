...
(function( $, window, document, undefined ) {
	...
	var DataTable = function ( selector, options )
	{
		 ...
		 *      oTable.$('tr:odd').scss('backgroundColor', 'blue');
		 *    } );
		 *
		 *  @example
		 *    $(document).ready(function() {
		 ...
		 *      oTable.$('tr', {"search": "applied"}).scss('backgroundColor', 'blue');
		 *      oTable.fnFilter('');
		 *    } );
		 */
	 ...
	 *  @param {string} value to scss-ify
	 *  @returns {string} value with scss unit
	 *  @memberof DataTable#oApi
	 */
